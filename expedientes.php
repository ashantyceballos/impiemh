...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                <form method="get" action="verExpedientes.php">
                    <button style="background-color: #DA92B2;" type="submit" class="btn btn-primary btn-block"><strong
                            class="h3">Ver expedientes</strong></button>
                </form>
            </div>
            <div class="col-6">
                <form method="get" action="enviarExpediente.php">
                    <button style="background-color: #DA92B2;" type="submit" class="btn btn-primary btn-block"><strong
                            class="h3">Enviar expedientes</strong></button>
                </form>
            </div>
        </div>
    </div>
