        ...
        <div class="row">
            ...
            <div class="container mt-3">
                <form>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputCity">Apellido paterno del paciente</label>
                            <input type="text" class="form-control" id="inputCity">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputCity">Apellido materno del paciente</label>
                            <input type="text" class="form-control" id="inputCity">
                        </div>
                    </div>
                    <div class="form-row">
                ...
                <div class="col-6">
                    <form method="get" action="guardar.php">
                        <button style="background-color: #DA92B2;" type="submit"
                            class="btn btn-primary btn-block"><strong class="h3">Guardar cita</strong></button>
                    </form>
                </div>
            </div>
        </div>
