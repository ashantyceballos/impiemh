            ...
            <thead>
                <tr>
                    <th scope="col">
                        ...
                        <br>
                        <a href="calendario.php">Agenda</a>
                    </th>
                    <th scope="col">
                        <img src="img/nuevopaciente.PNG" alt="logo">
                        <br>
                        <a href="nuevoPaciente.php">Nuevo Paciente</a>
                    </th>
                    <th scope="col">
                        <img src="img/llamada.PNG" alt="logo">
                        <br>
                        <a href="llamadaRescate.php">Llamada de rescate</a>
                    </th>
                    <th scope="col">
                        <img src="img/listadopacientes.PNG" alt="logo">
                        <br>
                        <a href="listadoPacientes.php">Listado de pacientes</a>
                    </th>
                    <th scope="col">
